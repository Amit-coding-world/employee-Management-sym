...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-teal-600 from-100% relative overflow-hidden">
              ...
              return (
                ...
                >
                  <div className="flex flex-col items-center text-center space-y-4">
                    <div
                      className={`w-20 h-20 rounded-full bg-gradient-to-br ${role.color} flex items-center justify-center transform transition-transform group-hover:rotate-12 group-hover:scale-110 shadow-lg`}
                    >
                    ...
                    <div className="mt-4 px-6 py-2 bg-yellow-600 rounded-full text-white text-sm font-medium group-hover:bg-yellow-700 transition-colors">
                      Login as {role.name}
                    </div>
                  </div>
                  ...
                  {/* Decorative corner */}
                  <div
                    className={`absolute top-0 right-0 w-20 h-20 bg-gradient-to-br ${role.color} opacity-20 rounded-bl-full rounded-tr-2xl`}
                  ></div>
                </div>
              );
            })}
          ...
          <div className="max-w-md mx-auto">
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-white/20">
              ...
              <div className="flex items-center justify-center mb-6">
                <div
                  className={`flex items-center space-x-3 px-6 py-3 rounded-full bg-gradient-to-r ${selectedRole.color} shadow-lg`}
                >
                  {selectedRole && (
                    <selectedRole.icon className="text-white text-2xl" />
                  )}
      ...
      {/* Footer */}
      <div className="relative z-10 mt-12 text-center text-black-500 text-sm">
