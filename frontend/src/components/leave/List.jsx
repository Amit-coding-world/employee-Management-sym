...
const List = () => {
    ...
    const renderStatusBadge = (status) => {
        ...
        return (
            <span className={
                ` px - 2 py - 1 rounded text - xs font - semibold ${colorClass}`
            }>
                {status} </span>
        );
    };
    ...
    return (
        <div className="p-6">
            ...
            <div className="flex justify-between items-center mb-4">
                ...
                user.role === "employee" && (
                    <Link to="/employee-dashboard/add-leave" className="bg-blue-600 text-white px-4 py-1 rounded hover:bg-blue-500">
                        Add New Leave
                    </Link>
                )
            } </div>
