    ...
    <div className="bg-gray-900 text-white h-screen fixed left-0 top-0 bottom-0 w-20 md:w-64 flex flex-col justify-between">
      ...
      <div>
        <div className="bg-teal-600 h-16 flex flex-col items-center justify-center space-y-1">
          ...
          <FaTachometerAlt className="md:hidden" size={20} />
        </div>
        ...
        <div className="space-y-2 mt-2 px-2">
          <NavLink
            ...
            className={({ isActive }) =>
              `${isActive ? "bg-teal-500" : "hover:bg-gray-700"} flex items-center justify-center md:justify-start space-x-3 py-2 px-3 rounded`
            }
          >
            <FaTachometerAlt />
