    ...
    return (
        <div className="p-5">
            ...
            <div className="flex justify-between items-center">
                <input type="text" placeholder="Search By Department Name" className="px-4 py-1 border border-gray-300 rounded"
                    onChange={filterDepartments}/>
                <Link to="/admin-dashboard/add-department" className="bg-blue-600 text-white px-4 py-1 rounded hover:bg-blue-500">
                    Add New Department
                </Link>
            </div>
